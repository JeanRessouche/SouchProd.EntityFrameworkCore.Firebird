...
{
    public class FirebirdPropertyAnnotations : RelationalPropertyAnnotations, IFirebirdPropertyAnnotations
    {
        public FirebirdPropertyAnnotations([NotNull] IProperty property)
            : base(property)
        {
        }

        protected FirebirdPropertyAnnotations([NotNull] RelationalAnnotations annotations)
            : base(annotations)
        {
        }
        ...
        public virtual FirebirdValueGenerationStrategy? GetFirebirdValueGenerationStrategy(bool fallbackToModel)
        {
            ...
            var value = (FirebirdValueGenerationStrategy?)Annotations.Metadata[FirebirdAnnotationNames.ValueGenerationStrategy];
        ...
        protected virtual bool SetValueGenerationStrategy(FirebirdValueGenerationStrategy? value)
        {
            ...
            return Annotations.SetAnnotation(FirebirdAnnotationNames.ValueGenerationStrategy, value);
        }
        ...
        protected virtual bool CanSetValueGenerationStrategy(FirebirdValueGenerationStrategy? value)
        {
            ...
            if (!Annotations.CanSetAnnotation(FirebirdAnnotationNames.ValueGenerationStrategy, value))
            {
                return false;
            }
