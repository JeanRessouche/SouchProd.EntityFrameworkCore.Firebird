...
{
    public class FbUpdateSqlGenerator : UpdateSqlGenerator, IFirebirdUpdateSqlGenerator
    {
            ...
            int commandPosition)
        {
            ...
            if (writeOperations.Any())
            {
                ...
                foreach (var t in modificationCommands)
                {
                    ...
                    {
                        var typeStr = FbSqlSqlGenerationHelper.GetTypeColumnToString(column, _mapper);
