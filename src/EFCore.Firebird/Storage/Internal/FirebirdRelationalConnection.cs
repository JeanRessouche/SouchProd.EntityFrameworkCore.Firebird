...
{
    public class FirebirdRelationalConnection : RelationalConnection, IFirebirdRelationalConnection
    {
        
        public FirebirdRelationalConnection([NotNull] RelationalConnectionDependencies dependencies)
            : base(dependencies)
        {
        }
        ...
        public virtual IFirebirdRelationalConnection CreateMasterConnection()
        {
            ...
            return new FirebirdRelationalConnection(Dependencies.With(contextOptions));
        }
        ...
        private async Task<IDbContextTransaction> BeginTransactionWithNoPreconditionsAsync(IsolationLevel isolationLevel, CancellationToken cancellationToken=default(CancellationToken))
        {
            ...
            CurrentTransaction
                = new FirebirdRelationalTransaction(
                    this,
                    dbTransaction,
        ...
        public override IDbContextTransaction UseTransaction(DbTransaction transaction)
        {
            ...
            else
            {
                ...
                CurrentTransaction = new FirebirdRelationalTransaction(
                    this, 
                    transaction, 
                    Dependencies.TransactionLogger, 
        ...
        public virtual async Task CommitTransactionAsync(CancellationToken cancellationToken=default(CancellationToken))
        {
            ...
            await (CurrentTransaction as FirebirdRelationalTransaction).CommitAsync().ConfigureAwait(false);
        }
        ...
        public virtual async Task RollbackTransactionAsync(CancellationToken cancellationToken=default(CancellationToken))
        {
            ...
            await (CurrentTransaction as FirebirdRelationalTransaction).RollbackAsync().ConfigureAwait(false);
        }
    }
}
