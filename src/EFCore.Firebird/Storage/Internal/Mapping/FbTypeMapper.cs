...
namespace Microsoft.EntityFrameworkCore.Storage.Internal
{
    public class FbTypeMapper : RelationalTypeMapper
    {
        ...
        // boolean
        private readonly FbBoolTypeMapping _bit       = new FbBoolTypeMapping("smallint", DbType.SByte);
	    ...
	    // binary
	    private readonly RelationalTypeMapping _binary           = new FbByteArrayTypeMapping("BLOB SUB_TYPE 0 SEGMENT SIZE 80", DbType.Binary);
        private readonly RelationalTypeMapping _varbinary        = new FbByteArrayTypeMapping("BLOB SUB_TYPE 0 SEGMENT SIZE 80", DbType.Binary);
	    private readonly FbByteArrayTypeMapping _varbinary767 = new FbByteArrayTypeMapping("BLOB SUB_TYPE 0 SEGMENT SIZE 80", DbType.Binary, 767);
	    private readonly RelationalTypeMapping _varbinarymax     = new FbByteArrayTypeMapping("BLOB SUB_TYPE 0 SEGMENT SIZE 80", DbType.Binary);

	    // string
        private readonly FbStringTypeMapping _char            = new FbStringTypeMapping("char", DbType.AnsiStringFixedLength);
        private readonly FbStringTypeMapping _varchar         = new FbStringTypeMapping("varchar", DbType.AnsiString);
	    private readonly FbStringTypeMapping _varchar127      = new FbStringTypeMapping("varchar(127)", DbType.AnsiString, true, 127);
	    private readonly FbStringTypeMapping _varcharmax      = new FbStringTypeMapping("varchar(4000)", DbType.AnsiString);

	    // DateTime
        private readonly FbDateTimeTypeMapping _timeStamp = new FbDateTimeTypeMapping("TIMESTAMP", DbType.DateTime);
        private readonly TimeSpanTypeMapping _time              = new TimeSpanTypeMapping("time", DbType.Time);

        // json
        private readonly RelationalTypeMapping _json = new FbStringTypeMapping("BLOB SUB_TYPE 1 SEGMENT SIZE 80", DbType.AnsiString);

        // row version
        private readonly RelationalTypeMapping _rowversion   = new FbDateTimeTypeMapping("TIMESTAMP", DbType.DateTime);
            ...
            : base(dependencies)
        {
            ...
            ByteArrayMapper // TODO
                = new ByteArrayRelationalTypeMapper(
                    ...
                    _varbinarymax,
                    _varbinary767,
                    _rowversion, size => new FbByteArrayTypeMapping("BLOB SUB_TYPE 0 SEGMENT SIZE 80", DbType.Binary));
