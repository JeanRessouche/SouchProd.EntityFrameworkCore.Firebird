...
{
    public class FirebirdMigrationsSqlGenerator : MigrationsSqlGenerator
    {
	    ...
	    public FirebirdMigrationsSqlGenerator(
        ...
        protected override void Generate([NotNull] MigrationOperation operation, [CanBeNull] IModel model, [NotNull] MigrationCommandListBuilder builder)
        {
            ...
            var createDatabaseOperation = operation as FirebirdCreateDatabaseOperation;
            ...
            var dropDatabaseOperation = operation as FirebirdDropDatabaseOperation;
            if (dropDatabaseOperation is FirebirdDropDatabaseOperation)
            {
            ...
            [NotNull] MigrationCommandListBuilder builder)
        {
            ...
            var valueGenerationStrategy = annotatable[FirebirdAnnotationNames.ValueGenerationStrategy] as FirebirdValueGenerationStrategy?;
