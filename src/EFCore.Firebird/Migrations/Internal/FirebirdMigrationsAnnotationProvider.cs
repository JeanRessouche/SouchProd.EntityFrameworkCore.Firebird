...
namespace Microsoft.EntityFrameworkCore.Migrations.Internal
{
    ...
    /// </summary>
    public class FirebirdMigrationsAnnotationProvider : MigrationsAnnotationProvider
    {
        /// <summary>
        ///     Initializes a new instance of this class.
        /// </summary>
        /// <param name="dependencies"> Parameter object containing dependencies for this service. </param>
        public FirebirdMigrationsAnnotationProvider([NotNull] MigrationsAnnotationProviderDependencies dependencies)
            : base(dependencies)
        {
        }
        ...
        public override IEnumerable<IAnnotation> For(IProperty property)
        {
            ...
            {
                yield return new Annotation(
                    FirebirdAnnotationNames.ValueGenerationStrategy,
